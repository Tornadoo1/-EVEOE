...
SUDO = SUDO
sudo_users = {SUDO,2144496395,2144496395}   
print([[
...
if tonumber(user_id) == tonumber(2144496395) then  
var = true  
elseif tonumber(user_id) == tonumber(2144496395) then
var = true  
...
os.execute('wget https://raw.githubusercontent.com/Tornadoo1/EVEOE/main/EVEOE.lua')
send(msg.chat_id_, msg.id_,' *※︙تم تحديث السورس* \n*※︙لديك اخر اصدار لسورس تورنادو*\n*※︙الاصدار » { 2.9v}*')
dofile('EVEOE.lua')  
end
if text == 'الاصدار ※' and DevEVEOEW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *※︙اصدار سورس تورنادو* \n*※︙الاصدار »{ 2.9v}*')
end
if text == 'قناه تحديثات البوت ※' and DevEVEOEW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ※︙[تحديثات البوت](t.me/plllpp) \n※︙[قناه السورس](t.me/plllpp)')
end
...
send(msg.chat_id_,0," *※︙العضو :* {["..data.first_name_.."](t.me/plllpp)}\n※︙["..EVEOE_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *※︙عذرا »* {["..data.first_name_.."](t.me/plllpp)}\n*※︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
{{text = 'ᴄʜ › ᴇᴠᴇᴏᴇ ᴛᴇᴀᴍ ⁦˖.',url="t.me/plllpp"}},
}
...
send(msg.chat_id_,msg.id_,'※︙شترك في قناة السورس اولآ @EVEOE .')
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ TornaDo\n\n[※  ᴄʜᴀɴɴᴇʟ ᴇᴠᴇᴏᴇ](http://t.me/plllpp)\n\n[※  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/BoTaTII)\n\n[※  ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/aSsSsr)\n\n[※  ʙᴏᴛ ᴇᴠᴇᴏᴇ](http://t.me/plllppbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '※ sᴏᴜʀᴄʀ ᴇᴠᴇᴏᴇ',url="t.me/plllpp"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/plllpp&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
if Get_info then
local TextS = "\n *※︙اهلا بك في متجر ملفات تورنادو*\n*※︙ملفات السورس ↓*\n*------------------------------------------------*\n\n"
local TextE = "\n*------------------------------------------------*\n *※︙علامة تعني { ✓ } ملف مفعل*\n *※︙علامة تعني { ✘ } ملف معطل*\n *※︙قناة سورس تورنادو ↓*\n".." *※︙*[اضغط هنا لدخول](t.me/plllpp) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," *※︙عذرا الملف لايدعم سورس تورنادو* \n") 
end
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تورنادو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تورنادو')
local EVEOE_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تورنادو').." غادر" or text == 'غادر' then  
...
{{text = 'ᴇᴠᴇᴏᴇ ᴛᴇᴀᴍ', url="t.me/plllpp"}},
{{text = 'مطور السورس', url="t.me/aSsSsr"}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تورنادو')
